...
String apiKey = "97DVBLLJAH7PEKFV";     // replace with your channel's thingspeak WRITE API key

String ssid="ii";    // Wifi network SSID
String password ="iiiiiiii";  // Wifi network password
...
void setup() {                
  ...
  espSerial.println("AT+CIOBAUD=9600");       //this line to set esp8266 serial speed to 9600 bps
  showResponse(1000);
